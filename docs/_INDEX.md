---
name: docs
description: Design specs, implementation references, distribution notes, and session handoff.
type: docs
updated: 2026-05-30
---
...
| `session-handoff-v1.md` | Resumable session state |
| `distribution-readme-ko.md` | Korean distribution/readme notes |
